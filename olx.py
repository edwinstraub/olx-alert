...
# OLX returns 403 for unfamiliar clients; present browser-like headers.
# Version must be a 4-part string (e.g. 138.0.0.0) and kept reasonably
# current — OLX's bot-detection rejects stale or malformed UA strings.
_HEADERS = {
    "User-Agent": (
